    ...
    <section class="w3l-content-with-photo-4" id="about">
        <div class="content-with-photo4-block editContent">
            <div class="container">
                ...
                <div class="my-bio">
                    <img src="{{ asset('frontend') }}/assets/images/1.jpg" alt="product"
        ...
        <div class="main-w3 ">
            <div class="container">
                <div class="right-side">
                    ...
                    <p class="mt-4 para">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nemo, soluta
                        impedit.
                        Consequatur,
            ...
            <div class="container">
                <div class="row">
                    <div class="my-bio cwp4-text col-lg-6">
                        ...
                        <a href="about.html" class="action-button btn mt-4">Read more <span
                                class="fa fa-angle-double-right"></span></a>
                    </div>
                    <div class="col-lg-6 ">
                        <img src="{{ asset('frontend') }}/assets/images/b4.jpg" alt="product"
                            class="img-responsive about-me">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-lg-3 col-md-6 col-sm-6 column">
                        <a href="#url"><img class="img img-responsive"
                                src="{{ asset('frontend') }}/assets/images/t1.jpg" alt=""></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 column">
                        <a href="#url"><img class="img img-responsive"
                                src="{{ asset('frontend') }}/assets/images/t2.jpg" alt=""></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 column">
                        <a href="#url"><img class="img img-responsive"
                                src="{{ asset('frontend') }}/assets/images/t3.jpg" alt=""></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 column">
                        <a href="#url"><img class="img img-responsive"
                                src="{{ asset('frontend') }}/assets/images/t4.jpg" alt=""></a>
                        <h4><a href="#url">Steve smith</a></h4>
                        <div class="w3l-team-7_bottom">
                            <div class="w3l-team-7_bottom-left">
                                <h6>Manager of company</h6>
