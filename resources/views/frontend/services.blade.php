                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul class="navbar-nav ml-lg-5">
                            ...
                            <li class="nav-item @@about__active">
                                <a class="nav-link" href="/about11">About</a>
                            </li>
            ...
            <div class="container">
                <div class="gallery-image row">
                    <div class="img-box col-lg-4 col-md-6">
                        <img src="{{ asset('frontend') }}/assets/images/b2.jpg" alt="product" class="img-responsive ">
                        <h5 class="mt-2"><a href="/about1">Turkey Grenada</a></h5>
                        <p class="para">4 Tours available</p>
                    </div>
                    <div class="img-box col-lg-4 col-md-6">
                        <img src="{{ asset('frontend') }}/assets/images/b1.jpg" alt="product" class="img-responsive ">
                        <h5 class="mt-2"><a href="/about1">Colosseum, Rome</a></h5>
                        <p class="para">9 Tours available</p>
                    </div>
                    <div class="img-box col-lg-4 col-md-6">
                        <img src="{{ asset('frontend') }}/assets/images/b3.jpg" alt="product" class="img-responsive ">
                        <h5 class="mt-2"><a href="/about1">Australia Nature</a></h5>
                        <p class="para">10 Tours available</p>
                    </div>
                    <div class="img-box col-lg-4 col-md-6">
                        <img src="{{ asset('frontend') }}/assets/images/b4.jpg" alt="product" class="img-responsive ">
                        <h5 class="mt-2"><a href="/about1">French-Polynesia
                            </a></h5>
                        <p class="para">8 Tours available</p>
                    </div>
                    <div class="img-box col-lg-4 col-md-6">
                        <img src="{{ asset('frontend') }}/assets/images/b5.jpg" alt="product" class="img-responsive ">
                        <h5 class="mt-2"><a href="/about1">South Island</a></h5>
                        <p class="para">5 Tours available</p>
                    </div>
                    <div class="img-box col-lg-4 col-md-6">
                        <img src="{{ asset('frontend') }}/assets/images/b6.jpg" alt="product" class="img-responsive ">
                        <h5 class="mt-2"><a href="/about1">Bora Bora</a></h5>
