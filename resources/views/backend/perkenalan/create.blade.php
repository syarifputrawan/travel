...
@section('content')
<form action="/perkenalan/store" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="content-wrapper">
        <div class="ml-3">
            <div class="mb-3">
                <label for="judul_singkat" class="form-label">judul singkat</label></label>
                <input type="text" class="form-control" id="judul_singkat" name="judul_singkat" placeholder="masukan judul singkat">
            </div>
        </div>
        <div class="ml-3">
            <div class="mb-3">
